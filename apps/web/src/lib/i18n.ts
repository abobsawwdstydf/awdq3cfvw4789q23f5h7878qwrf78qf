...
const LANG_KEY = 'Nimbus_language';
...
const translations = {
  ru: {
    ...
    // File/upload
    fileTooLarge: 'Файл слишком большой (макс. 20ГБ)',
    dropFileHere: 'Отпустите файл здесь',
    uploading: 'Загрузка...',
    changePhoto: 'Сменить фото',
    remove: 'Удалить',
    // New chat / channels
    newPersonalChat: 'Личный чат',
    chatWithFriend: 'Начать диалог',
    createChannel: 'Создать канал',
    broadcastMessages: 'Вещание для неограниченной аудитории',
    channelName: 'Название канала',
    channelNamePlaceholder: 'Введите название канала',
    channelUsername: 'Юзернейм канала',
    addMembersOptional: 'Добавить участников (необязательно)',
    unlimitedMembers: 'Неограниченное количество участников',
    // Formatting
    formatBold: 'Жирный',
